...
| `test-*.mjs`, `regression-suite.py`, `fuzz.mjs`, `run-all-tests.mjs` | The release gate (35 suites) |
...
`node run-all-tests.mjs` — must print **RELEASE GATE PASSED: all 35 suites passed**.
