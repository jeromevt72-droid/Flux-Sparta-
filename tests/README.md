...
| `test-*.mjs`, `regression-suite.py`, `fuzz.mjs`, `run-all-tests.mjs` | The release gate (34 suites) |
...
`node run-all-tests.mjs` — must print **RELEASE GATE PASSED: all 34 suites passed**.
